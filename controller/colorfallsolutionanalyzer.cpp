...
void ColorFallSolutionAnalyzer::findColorGroupIndexes(int index, int indexRow, int indexColumn,  const  QList<QColor>&  grid) {
...
QStringList ColorFallSolutionAnalyzer::getUpdatedFillColors(int  columnCount,  QList<int> indexColors,  QStringList colors) {
  //qDebug() << Q_FUNC_INFO << "  columnCount=" << columnCount << "  indexColors=" << indexColors << "  colors=" << colors.size();
  mFillColors.clear();
